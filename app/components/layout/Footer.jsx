...
const Footer = () => {
    ...
    const footerLinks = [
        ...
        },
        {
            title: 'Connect',
            links: [
                { name: 'GitHub', url: 'https://github.com/theeWaweru', external: true },
                { name: 'LinkedIn', url: 'https://linkedin.com', external: true },
                { name: 'Twitter', url: 'https://twitter.com', external: true },
                { name: 'Dribbble', url: 'https://dribbble.com', external: true }
            ]
        }
    ];
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-gray-400">
                            AI Creative Developer based in Nairobi, Kenya. Crafting digital experiences at the intersection of design, code, and artificial intelligence.
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm mb-4 md:mb-0">
                        © {currentYear} David Waweru. All rights reserved.
                    </p>
                    ...
                    <div className="flex space-x-6">
                        <a href="https://github.com/theeWaweru" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                            ...
                            <svg width="24px" height="auto"  className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
